                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.pages.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="page_name" id="page_name" value="{{ old('page_name', '') }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="page_link" id="page_link" value="{{ old('page_link', '') }}" required>
