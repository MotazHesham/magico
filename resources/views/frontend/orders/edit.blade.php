                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.orders.update", [$order->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="full_massage" id="full_massage" required>{{ old('full_massage', $order->full_massage) }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="tokens" id="tokens" value="{{ old('tokens', $order->tokens) }}" step="1" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="phone_number" id="phone_number" value="{{ old('phone_number', $order->phone_number) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="phone_number_2" id="phone_number_2" value="{{ old('phone_number_2', $order->phone_number_2) }}">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="shipping_address" id="shipping_address">{{ old('shipping_address', $order->shipping_address) }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="shift_id" id="shift_id">
                                @foreach($shifts as $id => $entry)
                                    <option value="{{ $id }}" {{ (old('shift_id') ? old('shift_id') : $order->shift->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                                @endforeach
                            </select>
                            @if($errors->has('shift'))
                                <div class="invalid-feedback">
