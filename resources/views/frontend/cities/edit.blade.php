                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.cities.update", [$city->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="cost" id="cost" value="{{ old('cost', $city->cost) }}" step="0.01" required>
                            @if($errors->has('cost'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('cost') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="code" id="code" value="{{ old('code', $city->code) }}" required>
                            @if($errors->has('code'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('code') }}
                                </div>
