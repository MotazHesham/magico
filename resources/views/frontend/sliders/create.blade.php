    ...
    <div class="card-body">
        <form method="POST" action="{{ route("frontend.sliders.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('headline_1') ? 'is-invalid' : '' }}" type="text" name="headline_1" id="headline_1" value="{{ old('headline_1', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('headline_2') ? 'is-invalid' : '' }}" type="text" name="headline_2" id="headline_2" value="{{ old('headline_2', '') }}">
