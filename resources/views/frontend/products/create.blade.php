    ...
    <div class="card-body">
        <form method="POST" action="{{ route("frontend.products.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control {{ $errors->has('colors') ? 'is-invalid' : '' }}" name="colors[]" placeholder="add colors ..." data-role="tagsinput">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control {{ $errors->has('sizes') ? 'is-invalid' : '' }}" name="sizes[]" placeholder="add sizes ..." data-role="tagsinput"> 
                @if($errors->has('sizes'))
                    <div class="invalid-feedback">
                        {{ $errors->first('sizes') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control {{ $errors->has('predictions') ? 'is-invalid' : '' }}" name="predictions[]"  placeholder="add predictions ..." data-role="tagsinput">
