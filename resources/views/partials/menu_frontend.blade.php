    ...
    <ul class="c-sidebar-nav">
        ...
        @if($theme_id = tenant('theme_id'))
            ...
            @can('frontend_setting_access')
                <li class="nav-title">{{ trans('cruds.frontendSetting.title') }}</li>
            @endcan 
                @can('slider_access')
                    <li class="c-sidebar-nav-item">
                        <a href="{{ route("frontend.sliders.index") }}" class="c-sidebar-nav-link {{ request()->is("sliders") || request()->is("sliders/*") ? "c-active" : "" }}">
                ...
                @endcan
                @can('creative_work_access')
                    <li class="c-sidebar-nav-item">
                        <a href="{{ route("frontend.creative-works.index") }}" class="c-sidebar-nav-link {{ request()->is("creative-works") || request()->is("creative-works/*") ? "c-active" : "" }}">
                            <i class="fa-fw fas fa-briefcase c-sidebar-nav-icon">

                            </i>
                            {{ trans('cruds.creativeWork.title') }}
                        </a>
                    </li>
                @endcan
                @can('service_access')
                    <li class="c-sidebar-nav-item">
                        <a href="{{ route("frontend.services.index") }}" class="c-sidebar-nav-link {{ request()->is("services") || request()->is("services/*") ? "c-active" : "" }}">
                ...
                @can('testimonial_access')
                    <li class="c-sidebar-nav-item">
                        <a href="{{ route("frontend.testimonials.index") }}" class="c-sidebar-nav-link {{ request()->is("testimonials") || request()->is("testimonials/*") ? "c-active" : "" }}">
                ...
                @can('contactu_access')
                    <li class="c-sidebar-nav-item">
                        <a href="{{ route("frontend.contactus.index") }}" class="c-sidebar-nav-link {{ request()->is("contactus") || request()->is("contactus/*") ? "c-active" : "" }}">
                            <i class="fa-fw far fa-address-card c-sidebar-nav-icon">
                ...
                @can('setting_access')
                    <li class="c-sidebar-nav-item">
                        <a href="{{ route("frontend.settings.index") }}" class="c-sidebar-nav-link {{ request()->is("settings") || request()->is("settings/*") ? "c-active" : "" }}">
                ...
                @if($theme_id != 1)
                    @can('faq_question_access')
                        <li class="c-sidebar-nav-item">
                            <a href="{{ route("frontend.faq-questions.index") }}" class="c-sidebar-nav-link {{ request()->is("faq-questions") || request()->is("faq-questions/*") ? "c-active" : "" }}">
                    ...
                    @can('content_management_access')
                        <li class="c-sidebar-nav-dropdown {{ request()->is("content-categories*") ? "c-show" : "" }} {{ request()->is("content-tags*") ? "c-show" : "" }} {{ request()->is("content-pages*") ? "c-show" : "" }}">
                            <a class="c-sidebar-nav-dropdown-toggle" href="#">
                            ...
                            <ul class="c-sidebar-nav-dropdown-items">
                                @can('content_category_access')
                                    <li class="c-sidebar-nav-item">
                                        <a href="{{ route("frontend.content-categories.index") }}" class="c-sidebar-nav-link {{ request()->is("content-categories") || request()->is("content-categories/*") ? "c-active" : "" }}">
                                ...
                                @can('content_tag_access')
                                    <li class="c-sidebar-nav-item">
                                        <a href="{{ route("frontend.content-tags.index") }}" class="c-sidebar-nav-link {{ request()->is("content-tags") || request()->is("content-tags/*") ? "c-active" : "" }}">
                                ...
                                @can('content_page_access')
                                    <li class="c-sidebar-nav-item">
                                        <a href="{{ route("frontend.content-pages.index") }}" class="c-sidebar-nav-link {{ request()->is("content-pages") || request()->is("content-pages/*") ? "c-active" : "" }}">
        ...
        @can('user_management_access')
            <li class="nav-title">{{ trans('cruds.userManagement.title') }}</li>
        @endcan 
            @can('role_access')
                <li class="c-sidebar-nav-item">
