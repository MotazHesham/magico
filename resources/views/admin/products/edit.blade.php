    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.products.update", [$product->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('colors') ? 'is-invalid' : '' }}" name="colors" id="colors">{{ old('colors', $product->colors) }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('sizes') ? 'is-invalid' : '' }}" name="sizes" id="sizes">{{ old('sizes', $product->sizes) }}</textarea>
                @if($errors->has('sizes'))
                    <div class="invalid-feedback">
                        {{ $errors->first('sizes') }}
                    </div>
