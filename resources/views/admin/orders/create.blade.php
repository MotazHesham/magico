    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.orders.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('full_massage') ? 'is-invalid' : '' }}" name="full_massage" id="full_massage" required>{{ old('full_massage') }}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('tokens') ? 'is-invalid' : '' }}" type="number" name="tokens" id="tokens" value="{{ old('tokens', '') }}" step="1" required>
